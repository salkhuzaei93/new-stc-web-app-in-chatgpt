...
export const orderTypes = ["I", "M", "C", "O"] as const;
export const transportTypes = ["Fiber", "Copper", "Transmission", "UPE"] as const;
export const vendorOptions = ["Cisco", "Huawei", "Juniper"] as const;
