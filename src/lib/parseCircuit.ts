export type CircuitLayer = "L2" | "L3";
...
export const parseCircuit = (input: string): ParsedCircuit => {
  ...
  let layer: CircuitLayer | null = null;
...
export const inferLayer = (typeToken: string): CircuitLayer | null => {
